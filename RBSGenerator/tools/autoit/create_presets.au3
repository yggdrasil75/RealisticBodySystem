...
Func createPresetFiles()
   ...
   addSetSlider("Hips", Randomize(-20*$bodyMultiLow,30*$bodyMultiHigh), Randomize(10*$bodyMultiLow , 80*$bodyMultiHigh * $multi),$file)
   ...
   addSetSlider("BreastGravity", $breastGravityLow , Randomize($breastGravityLow ,65*$bodyMultiHigh),$file)
   ...
   addSetSlider("AppleCheeks", Randomize(-30*$bodyMultiLow,0*$bodyMultiHigh), Randomize(0*$bodyMultiLow,70*$bodyMultiHigh),$file)
   addSetSlider("RoundAss" ,Randomize(-30*$bodyMultiLow,0*$bodyMultiHigh), Randomize(0*$bodyMultiLow,100*$bodyMultiHigh),$file)
