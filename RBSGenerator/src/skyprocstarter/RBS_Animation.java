...
public class RBS_Animation {
    ...
    public static void convertHKPFileToXML(String pathToHKPFile) {
    ...
    public static void generateHKPFile() throws Exception {
        ...
        for (File animationFolder : animationFolderList) {
            ...
            String command = SkyProcStarter.pathToHKXcmd + " convert \"" + targetPathSource + "\"" + " \"" + targetPathConverted + "\" -f:SAVE_TEXT_FORMAT";
